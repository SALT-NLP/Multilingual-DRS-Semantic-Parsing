...
class MemoryEfficientFP16Optimizer(_MemoryEfficientFP16OptimizerMixin, optim.FairseqOptimizer):
    ...
    *supports_memory_efficient_fp16* property.
    ...
    def get_lr_enc(self):
        return self.wrapped_optimizer.get_lr_enc()

    def get_lr_dec(self):
        return self.wrapped_optimizer.get_lr_dec()

    def set_lr_enc(self, lr):
        self.wrapped_optimizer.set_lr_enc(lr)

    def set_lr_dec(self, lr):
        self.wrapped_optimizer.set_lr_dec(lr)
